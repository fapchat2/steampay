<header>
    <div class="headerDiv m-auto">
        ...
        <div class="dropdown">
            <div>
              <a href="#" class="submenu-link"><svg id="dropdownMenuLink" data-bs-toggle="dropdown" xmlns="http://www.w3.org/2000/svg" width="42"
                height="42" fill="white" class="bi bi-list m-auto list" viewBox="0 0 16 16">
        ...
        <a class=" m-auto catalogue" href="#catalogue">
            каталог продукции
  ...
  <div class="dropdown_currency">
    <div>
      <a href="#currency" class="submenu-link">$</a>
      <ul class="submenu">
        <li><a href="#$">$</a></li>
        <li><a href="#€">€</a></li>
        <li><a href="#₽">₽</a></li>
...
<div class="dropdown-content">
    <div class="container-fluid">
        <div class="genres">
            <h1>Жанры</h1>
            <div class="genres_inner">
                <a href="action" class="action">
                    <h2>action</h2>
                </a>
                <a href="adventures" class="adventures">
                    <h2>adventures</h2>
                </a>
                <a href="rpg" class="rpg">
                    <h2>RPG</h2>
                </a>
                <a href="simulators" class="simulators">
                    <h2>simulators</h2>
                </a>
                <a href="strategies" class="strategies">
                    <h2>strategies</h2>
                </a>
                <a href="sport" class="sport">
                    <h2>sport</h2>
                </a>
                <a href="race" class="race">
                    <h2>race</h2>
                </a>
                <a href="casual" class="casual">
                    <h2>casual</h2>
                </a>
